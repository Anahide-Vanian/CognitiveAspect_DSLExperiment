...
def before_all(context):
    ...
    #execute the Scenario just once
...
#move the robot and return position to update global variable in tests.py
def moveRobot(context, position):
    ...
    writeText2SerialPort(context, text2)#2
    time.sleep(0.2)
    ...
    time.sleep(0.5)
    writeText2SerialPort(context, text2)#1
    time.sleep(0.5)
